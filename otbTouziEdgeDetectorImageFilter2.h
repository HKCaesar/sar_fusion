...
class ITK_EXPORT TouziEdgeDetectorImageFilter2 :  public ImageToModulusAndDirectionImageFilter<TInputImage, TOutputImage,
...
public:
  ...
  typedef TouziEdgeDetectorImageFilter2                                                              Self;
  ...
  itkTypeMacro(TouziEdgeDetectorImageFilter2, ImageToModulusAndDirectionImageFilter);
...
protected:
  TouziEdgeDetectorImageFilter2();
  virtual ~TouziEdgeDetectorImageFilter2() {}
...
private:
  TouziEdgeDetectorImageFilter2(const Self &); //purposely not implemented
...
#include "otbTouziEdgeDetectorImageFilter2.txx"
#endif
